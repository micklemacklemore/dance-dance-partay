...
namespace Puppet
{
    public class DancerRasputin : DancerBase
    {
        ...
        private float _maxJumpingHeight = 0.15f;
        ...
        private void UpdateBodyPosition()
        {
            ...
            {
                // Generate a new target offset for the next jump height
                _bodyPosTargetOffset = (UnityEngine.Random.Range(0.3f, 0.4f));
            }
        ...
        private void UpdateBodyRotation()
        {
            if (beatManager.NewCycle)
            {
                ...
                float randomYaw = UnityEngine.Random.Range(0.0f, 120.0f); // Random yaw rotation
